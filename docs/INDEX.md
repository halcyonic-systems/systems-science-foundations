...
| [../Systems/Challenge.lean](../Systems/Challenge.lean) | **Trusted statement file**: every headline claim restated with full types for cold verification (comparator pattern); run `scripts/check-challenge.sh` — 20 theorems, standard axioms only, `connected_is_single_arrow` axiom-free |
