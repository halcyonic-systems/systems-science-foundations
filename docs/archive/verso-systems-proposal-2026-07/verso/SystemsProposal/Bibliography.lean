...
Mesarovic, M.D. & Takahara, Y. (1975). *General Systems Theory: Mathematical Foundations*. New York: Academic Press. Definition 1.1 introduces the input-output framework that the shape category I\_Mesarovic encodes.
...
Myers, D.J. (2023). *Categorical Systems Theory*. Manuscript, Topos Institute. Section 2.1 defines systems as lenses — deterministic maps from state × input to state × output — encoded as I\_Myers.
...
Joslyn, C. (1995/2000). Semantic Control Systems. *World Futures: The Journal of General Evolution*, 45(1-4), 87–123. Proposition 29 establishes the semantic closure condition — a system that interprets its own constraints — central to the cybernetic tradition encoded as I\_Joslyn.
