...
\author{Claude (Fable 5.1), as prompted by Shingai Thornton\thanks{Byline follows the convention of the Multivar repository. The encoding decision, the readings of \J, and the question in \S4 are Shingai Thornton's; the mathematics in \S2 is machine-checked in \texttt{systems-science-foundations/Systems/Category/\{ShapeJoslyn, CyclicObstruction, JoslynIncomparability\}.lean}, checkout \texttt{4288793}. \J{} = C.~Joslyn, ``Semantic Control Systems,'' \emph{World Futures} 45 (1995) 87--123.}}
