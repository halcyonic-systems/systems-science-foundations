...
**Next**: Remaining unresolved: #6 Evolution, #11 Understandability, #12 Improvability. **Two stretches open**: (a) Self-Models — existence/obstruction of a *faithful* self-model via Lawvere's fixed-point theorem (Mathlib has only the powerset diagonal); (b) Information — mutual information, the data-processing inequality, operational channel capacity, and the semantic/viability layer above the genus. Both are separate research-level sessions.
