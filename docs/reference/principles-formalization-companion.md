...
| 10 | Self-Models | 2 | **Theorem** (tractable core) | Diagonal case of #9 (`InternalModel S S`): self-anticipation for free, existence is trivial (identity), accurate self-image is dynamics-invariant. No new axiom. Faithful-existence (Lawvere/diagonal) deferred. |
